...
void displayadsrgraph() {
  if (sublevels[2] == 2 ) {
     ...
     navleveloverwrite = 4;
      ...
      //mappedsustain
      int totalliner = mappedattack*10 + mappeddecay + 100 + mappedrelease + MadsrAttackDelay*2 + MadsrHold +5 ;
 ...
 switch(sublevels[navleveloverwrite]) {
  ...
  case 1 :
  display.fillRect(a0, starty, round(mappedattack*10*linerratio)+2, 45, SSD1306_INVERSE);
  display.display();
  ...
  break;
   ...
   case 2 :
   display.fillRect(h0, starty, round(MadsrHold*linerratio)+2, 45, SSD1306_INVERSE);
    display.display();
 
  sliceH();
  break;
   case 3 :
   display.fillRect(d0, starty, round(mappeddecay*linerratio)+1, 45, SSD1306_INVERSE);
    display.display();
  ...
  break;
   ...
   display.fillRect(s0, starty, round(95*linerratio)+1, 45, SSD1306_INVERSE);
    display.display();
 
    sliceS();
  break;
  case 5 :
   display.fillRect(r0, starty, round(mappedrelease*linerratio)+1, 45, SSD1306_INVERSE);
    display.display();
