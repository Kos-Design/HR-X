       ...
       if (!demimalmode) {
           ...
           setwavetypefromlist(ccsynthselector, Waveformstyped[ccsynthselector]);
            ...
            //  mixle303ffilterzVknobs[0]
              ...
              filtercontrols(ccfxlineselector);
                break;
                case 73:
             bqVpot[ccfxlineselector][bqstage[ccfxlineselector]][0] = round( smallfloat * 128.0 ) ;
             ...
             if (bqfreq[ccfxlineselector][bqstage[ccfxlineselector]] >= 101) {
                ...
                break;
                case 74:
              bqVpot[ccfxlineselector][bqstage[ccfxlineselector]][1] = round( smallfloat * 128.0 ) ;
              ...
              bqVpot[ccfxlineselector][bqstage[ccfxlineselector]][2]= round( smallfloat * 128.0 ) ;
        ...
        restartdelayline(ccfxlineselector);
          break;
           ...
           case 96 :
          //type
          bqtype[ccfxlineselector][bqstage[ccfxlineselector]] = round (smallfloat * 5.0 ) ;
          if (bqfreq[ccfxlineselector][bqstage[ccfxlineselector]] >= 101) {
                    biquadcontrols(ccfxlineselector);
                }
          break;
