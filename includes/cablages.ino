...
EXTMEM AudioConnection premixMtom1(premixMaster, 0, multiply1, 0);
EXTMEM AudioConnection premixMtom2(premixMaster, 0, multiply2, 0);
EXTMEM AudioConnection premixMtom3(premixMaster, 0, multiply3, 0);

EXTMEM AudioConnection mul1towetL1(multiply1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection mul1towetR1(multiply1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection mul2towetL1(multiply2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection mul2towetR1(multiply2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection mul3towetL1(multiply3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection mul3towetR1(multiply3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection mul1towetL2(multiply1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection mul1towetR2(multiply1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection mul2towetL2(multiply2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection mul2towetR2(multiply2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection mul3towetL2(multiply3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection mul3towetR2(multiply3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection mul1towetL3(multiply1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection mul1towetR3(multiply1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection mul2towetL3(multiply2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection mul2towetR3(multiply2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection mul3towetL3(multiply3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection mul3towetR3(multiply3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtog1(premixMaster, 0, granular1, 0);
EXTMEM AudioConnection premixMtog2(premixMaster, 0, granular2, 0);
EXTMEM AudioConnection premixMtog3(premixMaster, 0, granular3, 0);

EXTMEM AudioConnection g1towetL1(granular1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection g1towetR1(granular1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection g2towetL1(granular2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection g2towetR1(granular2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection g3towetL1(granular3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection g3towetR1(granular3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection g1towetL2(granular1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection g1towetR2(granular1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection g2towetL2(granular2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection g2towetR2(granular2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection g3towetL2(granular3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection g3towetR2(granular3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection g1towetL3(granular1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection g1towetR3(granular1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection g2towetL3(granular2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection g2towetR3(granular2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection g3towetL3(granular3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection g3towetR3(granular3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtobt1(premixMaster, 0, bitcrusher1, 0);
EXTMEM AudioConnection premixMtobt2(premixMaster, 0, bitcrusher2, 0);
EXTMEM AudioConnection premixMtobt3(premixMaster, 0, bitcrusher3, 0);

EXTMEM AudioConnection bt1towetL1(bitcrusher1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection bt1towetR1(bitcrusher1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection bt2towetL1(bitcrusher2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection bt2towetR1(bitcrusher2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection bt3towetL1(bitcrusher3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection bt3towetR1(bitcrusher3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection bt1towetL2(bitcrusher1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection bt1towetR2(bitcrusher1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection bt2towetL2(bitcrusher2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection bt2towetR2(bitcrusher2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection bt3towetL2(bitcrusher3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection bt3towetR2(bitcrusher3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection bt1towetL3(bitcrusher1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection bt1towetR3(bitcrusher1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection bt2towetL3(bitcrusher2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection bt2towetR3(bitcrusher2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection bt3towetL3(bitcrusher3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection bt3towetR3(bitcrusher3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtorev1(premixMaster, 0, freeverbs1, 0);
EXTMEM AudioConnection premixMtorev2(premixMaster, 0, freeverbs2, 0);
EXTMEM AudioConnection premixMtorev3(premixMaster, 0, freeverbs3, 0);

EXTMEM AudioConnection rev1towetL1(freeverbs1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection rev1towetR1(freeverbs1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection rev2towetL1(freeverbs2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection rev2towetR1(freeverbs2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection rev3towetL1(freeverbs3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection rev3towetR1(freeverbs3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection rev1towetL2(freeverbs1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection rev1towetR2(freeverbs1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection rev2towetL2(freeverbs2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection rev2towetR2(freeverbs2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection rev3towetL2(freeverbs3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection rev3towetR2(freeverbs3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection rev1towetL3(freeverbs1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection rev1towetR3(freeverbs1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection rev2towetL3(freeverbs2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection rev2towetR3(freeverbs2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection rev3towetL3(freeverbs3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection rev3towetR3(freeverbs3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtofl1(premixMaster, 0, flange1, 0);
EXTMEM AudioConnection premixMtofl2(premixMaster, 0, flange2, 0);
EXTMEM AudioConnection premixMtofl3(premixMaster, 0, flange3, 0);

EXTMEM AudioConnection fl1towetL1(flange1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection fl1towetR1(flange1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection fl2towetL1(flange2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection fl2towetR1(flange2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection fl3towetL1(flange3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection fl3towetR1(flange3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection fl1towetL2(flange1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection fl1towetR2(flange1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection fl2towetL2(flange2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection fl2towetR2(flange2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection fl3towetL2(flange3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection fl3towetR2(flange3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection fl1towetL3(flange1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection fl1towetR3(flange1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection fl2towetL3(flange2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection fl2towetR3(flange2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection fl3towetL3(flange3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection fl3towetR3(flange3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtoch1(premixMaster, 0, chorus1, 0);
EXTMEM AudioConnection premixMtoch2(premixMaster, 0, chorus2, 0);
EXTMEM AudioConnection premixMtoch3(premixMaster, 0, chorus3, 0);

EXTMEM AudioConnection ch1towetL1(chorus1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection ch1towetR1(chorus1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection ch2towetL1(chorus2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection ch2towetR1(chorus2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection ch3towetL1(chorus3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection ch3towetR1(chorus3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection ch1towetL2(chorus1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection ch1towetR2(chorus1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection ch2towetL2(chorus2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection ch2towetR2(chorus2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection ch3towetL2(chorus3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection ch3towetR2(chorus3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection ch1towetL3(chorus1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection ch1towetR3(chorus1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection ch2towetL3(chorus2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection ch2towetR3(chorus2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection ch3towetL3(chorus3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection ch3towetR3(chorus3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtobq1(premixMaster, 0, biquad1, 0);
EXTMEM AudioConnection premixMtobq2(premixMaster, 0, biquad2, 0);
EXTMEM AudioConnection premixMtobq3(premixMaster, 0, biquad3, 0);

EXTMEM AudioConnection bq1towetL1(biquad1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection bq1towetR1(biquad1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection bq2towetL1(biquad2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection bq2towetR1(biquad2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection bq3towetL1(biquad3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection bq3towetR1(biquad3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection bq1towetL2(biquad1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection bq1towetR2(biquad1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection bq2towetL2(biquad2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection bq2towetR2(biquad2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection bq3towetL2(biquad3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection bq3towetR2(biquad3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection bq1towetL3(biquad1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection bq1towetR3(biquad1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection bq2towetL3(biquad2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection bq2towetR3(biquad2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection bq3towetL3(biquad3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection bq3towetR3(biquad3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtoff1(premixMaster, 0, filter1, 0);
EXTMEM AudioConnection premixMtoff2(premixMaster, 0, filter2, 0);
EXTMEM AudioConnection premixMtoff3(premixMaster, 0, filter3, 0);

EXTMEM AudioConnection ff1towetL1(mixfilter1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection ff1towetR1(mixfilter1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection ff2towetL1(mixfilter2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection ff2towetR1(mixfilter2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection ff3towetL1(mixfilter3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection ff3towetR1(mixfilter3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection ff1towetL2(mixfilter1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection ff1towetR2(mixfilter1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection ff2towetL2(mixfilter2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection ff2towetR2(mixfilter2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection ff3towetL2(mixfilter3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection ff3towetR2(mixfilter3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection ff1towetL3(mixfilter1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection ff1towetR3(mixfilter1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection ff2towetL3(mixfilter2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection ff2towetR3(mixfilter2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection ff3towetL3(mixfilter3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection ff3towetR3(mixfilter3, 0, WetMixMasterR, 3);

EXTMEM AudioConnection premixMtode1(premixMaster, 0, feedbackdelay1, 0);
EXTMEM AudioConnection premixMtode2(premixMaster, 0, feedbackdelay2, 0);
EXTMEM AudioConnection premixMtode3(premixMaster, 0, feedbackdelay3, 0);

EXTMEM AudioConnection de1towetL1(delaymix1, 0, WetMixMasterL, 1);
EXTMEM AudioConnection de1towetR1(delaymix1, 0, WetMixMasterR, 1);
EXTMEM AudioConnection de2towetL1(delaymix2, 0, WetMixMasterL, 1);
EXTMEM AudioConnection de2towetR1(delaymix2, 0, WetMixMasterR, 1);
EXTMEM AudioConnection de3towetL1(delaymix3, 0, WetMixMasterL, 1);
EXTMEM AudioConnection de3towetR1(delaymix3, 0, WetMixMasterR, 1);

EXTMEM AudioConnection de1towetL2(delaymix1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection de1towetR2(delaymix1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection de2towetL2(delaymix2, 0, WetMixMasterL, 2);
EXTMEM AudioConnection de2towetR2(delaymix2, 0, WetMixMasterR, 2);
EXTMEM AudioConnection de3towetL2(delaymix3, 0, WetMixMasterL, 2);
EXTMEM AudioConnection de3towetR2(delaymix3, 0, WetMixMasterR, 2);

EXTMEM AudioConnection de1towetL3(delaymix1, 0, WetMixMasterL, 3);
EXTMEM AudioConnection de1towetR3(delaymix1, 0, WetMixMasterR, 3);
EXTMEM AudioConnection de2towetL3(delaymix2, 0, WetMixMasterL, 3);
EXTMEM AudioConnection de2towetR3(delaymix2, 0, WetMixMasterR, 3);
EXTMEM AudioConnection de3towetL3(delaymix3, 0, WetMixMasterL, 3);
EXTMEM AudioConnection de3towetR3(delaymix3, 0, WetMixMasterR, 3);
...
AudioMixer4 *delayprefeed[fxs_count] = {&premixmixx1, &premixmixx2, &premixmixx3};
...
AudioMixer4 *les303wet[liners_count] = {&mixerWet303L1, &mixerWet303L2, &mixerWet303L3,
...
EXTMEM AudioConnection octowetL2(octavedown1, 0, WetMixMasterL, 2);
EXTMEM AudioConnection octowetR2(octavedown1, 0, WetMixMasterR, 2);
EXTMEM AudioConnection premixMtoOc(premixMaster, octavedown1);
*/