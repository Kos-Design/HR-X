...
EXTMEM AudioEffectChorus        chorus1R; //xy=2875.66650390625,1634.6666259765625
...
EXTMEM AudioEffectFlange        flange2;        //xy=2987,1002
EXTMEM AudioEffectChorus        chorus2;        //xy=2991,1046
...
EXTMEM AudioEffectFlange        flange2R; //xy=3020.66650390625,1604.6666259765625
EXTMEM AudioEffectChorus        chorus2R; //xy=3024.66650390625,1648.6666259765625
...
EXTMEM AudioEffectFlange        flange3R; //xy=3165.66650390625,1602.6666259765625
EXTMEM AudioEffectChorus        chorus3R; //xy=3168.66650390625,1645.6666259765625
...
EXTMEM AudioConnection          patchCord97(envelopeL5, 0, mixerWL5to8, 1);
EXTMEM AudioConnection          patchCord98(envelopeL1, 0, mixerWL1to4, 1);
EXTMEM AudioConnection          patchCord99(envelopeL0, 0, mixerWL1to4, 0);
EXTMEM AudioConnection          patchCord100(envelopeL2, 0, mixerWL1to4, 2);
EXTMEM AudioConnection          patchCord101(envelopeL3, 0, mixerWL1to4, 3);
EXTMEM AudioConnection          patchCord102(envelopeL4, 0, mixerWL5to8, 0);
